...
<!-- 타이틀 배너 -->
<h1>
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&pause=1000&color=10B981&center=true&vCenter=true&width=600&lines=Hey%2C+I'm+Hooney+%F0%9F%91%8B;Fullstack+Architect+%7C+AI+Explorer;Finance+%C2%B7+Logistics+Domain+Expert" alt="Typing SVG" />
</h1>
...
```yaml
name: 곽경훈 (Hooney)
role: Senior Fullstack Architect / AI Explorer
location: Seoul, South Korea
domains:
  - Finance (금융감독원 — WebRTC 화상회의, 메신저, 보안 시스템)
  - Logistics (LX Pantos — 차세대 물류 ERP, Kafka 이벤트 스트리밍)
strengths:
  - "복잡한 도메인 로직을 견고한 아키텍처로 설계하는 것"
  - "레거시 환경에서도 현대적 엔지니어링 표준을 도입하는 것"
  - "현장을 직접 뛰어다니며 근본 원인을 파악하는 문제 해결 방식"
currently_studying:
  - LLM Fine-tuning & RAG Pipeline
  - PyTorch / Transformer Architecture
  - AI Backend Integration (Spring + FastAPI)
```
...
> 단순한 구현을 넘어, **설계 철학과 기술적 의사결정 과정**을 기록한 연구 저장소입니다.
...
- ✅ **ISMS-P 정기 심사 합격 기여** — RSA/AES-256 하이브리드 암호화 설계
- ✅ **금융권 보안 표준 적용** — CSRF 이중 방어(Double Submit Cookie + SameSite), MFA 구현
- ✅ **이기종 DB 간 3,000만 건 무손실 암호화 마이그레이션** 성공
